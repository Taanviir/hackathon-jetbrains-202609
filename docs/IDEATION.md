# Help the Developer (JetBrains challenge) — ideation notes

> **Archive note (22 September 2026).** This was the project README during ideation. The
> idea has since been picked and a plugin skeleton now exists, so the README became the
...
Scene files are in [docs/diagrams](./diagrams). Drag one onto the Excalidraw board to
...
- [ideas-board](./diagrams/ideas-board.excalidraw) is 22 ideas as sticky notes, green
  where Jev is load-bearing and amber where an LLM could do the same job. Drop this one in
  first and dot-vote three each.
- [00-two-tier-principle](./diagrams/00-two-tier-principle.excalidraw) is the shape all
  three candidates share. Read it before voting.
- [a-semantic-inspections](./diagrams/a-semantic-inspections.excalidraw)
- [b-codebase-triage](./diagrams/b-codebase-triage.excalidraw)
- [c-llm-rubric](./diagrams/c-llm-rubric.excalidraw)
